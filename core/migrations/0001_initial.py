    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-layers', 'Design'), ('lni-rocket', 'Foguete'), ('lni-mobile', 'Mobile'), ('lni-users', 'Usuarios'), ('lni-stats-up', 'Grafico'), ('lni-cog', 'Engrenagem')], max_length=12, verbose_name='Icone')),
            ],
            options={
